...
<body>
    <header>
        ...
        <div class="header-buttons">
            <a href="#l1" class="contact-btn">Contact Us</a>
    ...
    <section class="container">
       <div class="arrows prev">
        ...
        <div class="padding-box1" id="box-1">
            <img src="bx1.png">
            <a href="#" onclick="openalert()"><img src="next.png"></a>
        </div>
        ...
        <div class="padding-box4" id="box-4">
            <a href="#" onclick="openalert()" ><img src="right.png"></a>
    ...
    <div class="cat">
        <div class="cat1" id="b1">
            <a href="#" onclick="openalert()"><img src="car.png"></a>
            <text class="t1">CARPOOLING</text>
        </div>
        <div class="cat2" id="b2">
            <a href="#" onclick="openalert()"><img src="ticket.png"></a>
            <text class="t1">TICKETS</text>
        </div>
        <div class="cat3" id="b3">
            <a href="#" onclick="openalert()"><img src="house.png"></a>
    ...
    <div class="alrt" id="alrt">
        ...
        <a href="login.php">
        <button type="button" onclick="login.php">LOGIN</button></a>
    </div>
</body>
    <footer>
