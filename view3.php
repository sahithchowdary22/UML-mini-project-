...
<h2>Find your <span style="color: rgb(255, 140, 0);"> BED!</span></h2>
    <div class="container_display">
        <?php 
            $sql = "SELECT * FROM images where category='roomsharing' ORDER BY id DESC";
            ...
            if(mysqli_num_rows($res) > 0) {
                while ($images = mysqli_fetch_assoc($res)) { 
                    ...
                    echo '<div class="result-item-location">'.$images['landmark'].'</div>';
                    echo '</div>';
