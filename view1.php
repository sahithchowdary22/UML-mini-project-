...
<h2>Find your <span style="color: rgb(255, 140, 0);"> SEAT!</span></h2>
    <div class="container_display">
        ...
        <?php 
            $sql = "SELECT * FROM images where category='carpooling' ORDER BY id DESC";
            ...
            if(mysqli_num_rows($res) > 0) {
                while ($images = mysqli_fetch_assoc($res)) { 
                    ...
                    echo '<div class="iconig"><img src="map.png" ></div>';
                      echo '<div class="result-item-loction1">'.$images['from'].'</div>';
                      echo '<span class="arrow">&rarr;</span>';
                      echo '<div class="result-item-loction2">'.$images['to'].'</div>';
                      echo '</div>';
