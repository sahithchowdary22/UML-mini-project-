...
<body>
    <div class="container_display">
        <?php 
            $sql = "SELECT * FROM images where  ORDER BY id DESC";
            ...
            if(mysqli_num_rows($res) > 0) {
             ...
             echo '<button class="result-item-button chat"><a href="https://wa.me/' . $images['number'] . '"><i class="fa fa-comments"></i> Chat</a></button>';
                    ...
                    $store=Number;
                    echo '<button class="result-item-button show-number"><i class="fa fa-phone"></i>">'.$store.'</a></button>';
                    echo '<button class="result-item-button chat"><i class="fa fa-comments"></i> Chat</a></button>';
