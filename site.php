...
<body>
    ...
    <div class="search-boxes">
        ...
        <div class="search-box2">
            <input type="text" placeholder="Search item" class="item-search" name="search" id="search">
    ...
    <section class="container">
        ...
        <div class="padding-box1" id="box-1">
            <a href="#"><img src="box2.png"></a>
        </div>
        <div class="padding-box2" id="box-2">
            <a href="#"><img src="box1.png"></a>
        </div>
        <div class="padding-box3" id="box-3">
            <a href="#"><img src="box3.png"></a>
        </div>
...
//     //  $cat= $_POST['category'];
 ...
 //$cat = filter_input(INPUT_POST, 'category', FILTER_SANITIZE_STRING);
    ...
    $sql = "SELECT * FROM images WHERE category REGEXP '^$search';";
